...
impl TimezoneCalculator {
    ...
    pub fn today_start(&self) -> DateTime<Utc> {
        ...
        let start_time = today.and_hms_opt(self.daily_cutoff_hour.into(), 0, 0)
            .expect("Invalid daily cutoff hour");
        
        self.timezone.from_local_datetime(&start_time)
            .single()
    ...
    pub fn today_end(&self) -> DateTime<Utc> {
        ...
        let end_time = next_day.and_hms_opt(self.daily_cutoff_hour.into(), 0, 0)
            .expect("Invalid daily cutoff hour") - chrono::Duration::seconds(1);
        
        self.timezone.from_local_datetime(&end_time)
            .single()
            .expect("Unambiguous local time")
            .with_timezone(&Utc)
    }
    ...
    pub fn yesterday_start(&self) -> DateTime<Utc> {
        ...
        let start_time = yesterday.and_hms_opt(self.daily_cutoff_hour.into(), 0, 0)
            .expect("Invalid daily cutoff hour");
    ...
    pub fn yesterday_end(&self) -> DateTime<Utc> {
        ...
        let end_time = today.and_hms_opt(self.daily_cutoff_hour.into(), 0, 0)
            .expect("Invalid daily cutoff hour") - chrono::Duration::seconds(1);
    ...
    pub fn this_week_start(&self) -> DateTime<Utc> {
        ...
        let start_time = monday.and_hms_opt(self.daily_cutoff_hour.into(), 0, 0)
            .expect("Invalid daily cutoff hour");
    ...
    pub fn this_month_start(&self) -> DateTime<Utc> {
        ...
        let start_time = first_of_month.and_hms_opt(self.daily_cutoff_hour.into(), 0, 0)
            .expect("Invalid daily cutoff hour");
...
mod tests {
    use super::*;
    use chrono::{Weekday, NaiveTime, Timelike};
